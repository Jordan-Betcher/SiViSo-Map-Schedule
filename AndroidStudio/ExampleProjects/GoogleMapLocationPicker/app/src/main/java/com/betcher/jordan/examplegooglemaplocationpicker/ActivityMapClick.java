...
public class ActivityMapClick extends AppCompatActivity implements OnMapReadyCallback
{
	...
	public void setSivisoMarker(LatLng latLng)
	{
		...
		{
			sivisoMarker = mMap.addMarker(new MarkerOptions().position(latLng).title("SiViSo"));
